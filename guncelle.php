...
if (isset($_GET['id'])) {
    ...
    $secQuery = "SELECT * FROM kullanicibilgileri WHERE id = $id";
...
<?php
    ...
    $guncelleQuery = "UPDATE kullanicibilgileri SET adsoyad = '$adsoyad', kullaniciAdi = '$kullaniciAdi', email = '$email', telefon = '$telefon', sifre = '$sifre', dogumTarihi = '$dogumTarihi' WHERE id = $id";
