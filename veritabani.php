...
<body>
    ...
    <table id="customers">
        ...
        if ($_SESSION["user"] == "") {
          ...
          echo "<a href='veritabani_cikis.php' class='cikis-link'>Çıkış Yap</a><br>";
            include("dijital.php");

            $sec = "SELECT * FROM kullanicibilgileri";
        ...
        if (isset($_GET['sil'])) {
            $silId = $_GET['sil'];
            $silQuery = "DELETE FROM kullanicibilgileri WHERE id = $silId";
